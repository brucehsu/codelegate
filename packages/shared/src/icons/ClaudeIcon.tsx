...
const ClaudeIconIcon = ({
  ...
  const baseMinY = 0;
  const baseWidth = 256;
  const baseHeight = 256.194;
  const viewBox = `${baseMinX - padding} ${baseMinY - padding} ${baseWidth + (padding * 2)} ${baseHeight + (padding * 2)}`;
